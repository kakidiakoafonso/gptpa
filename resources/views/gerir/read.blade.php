              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="e-commerce">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{route("tpa.create")}}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Cadastrar</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{route("tpa.read")}}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Listar</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
              ...
              <div class="table-responsive scrollbar">
                ...
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                  <thead class="bg-200 text-900">
                    <tr>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="name">ID POS</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="email">Marca</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Modelo</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Cor</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Número de série</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Estado</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Descrição</th>
                  ...
                  <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->idPos}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->marca}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->modelo}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->cor}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->numero_serie}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->estado}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->descricao}}</td>
                        {{-- <td class="align-middle white-space-nowrap py-2 ">{{$tpa->endereco->endereco}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->endereco->municipio}}</td>
                        <td class="align-middle white-space-nowrap py-2 ">{{$tpa->endereco->provincia}}</td> --}}
                            ...
                            <div class="dropdown font-sans-serif position-static">
                              ...
                              <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                <div class="bg-white py-2">
                                    <a class="dropdown-item" href="{{route('tpa.updateView',$tpa->id)}}">Editar</a>
                                    <a class="dropdown-item text-danger" href="{{route('tpa.delete',$tpa->id)}}">Apagar</a></div>
                              </div>
                            </div>
                          </td>
                    </tr>

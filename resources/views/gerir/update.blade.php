          ...
          <div class="card mb-3">
            <div class="card-body">
              <div class="row flex-between-center">
                <div class="col-md">
                  <h5 class="mb-2 mb-md-0">Cadastrar TPA</h5>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-0" >
            <div class="col-lg-12 pe-lg-2" >
              <div class="card mb-3">
                ...
                <div class="card-header">
                  <h5 class="mb-0">Detalhes do TPA</h5>
                </div>
                <div class="card-body bg-light">


                    <form method="POST" action="{{route("tpa.update",$tpa->id)}}">
                        @csrf
                        <div class="row gx-2">
                          ...
                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-city">Marca</label>
                            <input class="form-control" id="event-city" type="text" placeholder="Marca" name="marca" value="{{$tpa->marca}}"/>
                          </div>
                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-state">Modelo</label>
                            <input class="form-control" id="event-state" type="text" placeholder="Modelo" name="modelo" value="{{$tpa->modelo}}"/>

                          </div>
                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-country">Cor</label>
                            <input class="form-control" type="text" placeholder="Cor" name="cor" value="{{$tpa->cor}}"/>
                          </div>

                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-city">Numero de serie</label>
                            <input class="form-control" type="text" placeholder="Número de série" name="numero_serie" value="{{$tpa->numero_serie}}"/>
                          </div>
                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-state">Descrição</label>
                            <input class="form-control" id="event-state" type="text" placeholder="Descrição" name="descricao" value="{{$tpa->descricao}}"/>
                          </div>
                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-country">Estado</label>
                            <select class="form-control" name="estado" >
                                ...
                                @if ($tpa->estado === "Inativo")
                                    selected
                                @endif
                                >Inativo</option>
                                <option value="Manutenção"
                                @if ($tpa->estado === "Manutenção")
                                    selected
                                @endif
                                >Manutenção</option>
                            </select>
                          ...
                          <div class="col-sm-4 mb-3">
                            <label class="form-label" for="event-city">ID Pos</label>
                            <input class="form-control" id="event-state" type="text" placeholder="ID POS" name="idPos" value="{{$tpa->idPos}}"/>

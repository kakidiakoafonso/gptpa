            ...
            <div class="col-lg-12 pe-lg-2" >
              <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                  ...
                  <form method="POST" action="{{route("tpa.create")}}">
                    @csrf
                    <div class="row gx-2">
                      ...
                      <div class="col-sm-4 mb-3">
                        ...
                        <input class="form-control" id="event-city" type="text" placeholder="Marca" name="marca"/>
                      </div>
                      <div class="col-sm-4 mb-3">
                        <label class="form-label" for="event-state">Modelo</label>
                        <input class="form-control" id="event-state" type="text" placeholder="Modelo" name="modelo"/>

                      </div>
                      <div class="col-sm-4 mb-3">
                        <label class="form-label" for="event-country">Cor</label>
                        <input class="form-control" type="text" placeholder="Cor" name="cor"/>
                      </div>

                      <div class="col-sm-4 mb-3">
                        <label class="form-label" for="event-city">Numero de serie</label>
                        <input class="form-control" type="text" placeholder="Número de série" name="numero_serie"/>
                      </div>
                      <div class="col-sm-4 mb-3">
                        <label class="form-label" for="event-state">Descrição</label>
                        <input class="form-control" id="event-state" type="text" placeholder="Descrição" name="descricao"/>
                      </div>
                      <div class="col-sm-4 mb-3">
                      ...
                      <div class="col-sm-4 mb-3">
                        ...
                        <input class="form-control" id="event-state" type="text" placeholder="ID POS" name="idPos"/>
